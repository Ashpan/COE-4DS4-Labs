...
void BOARD_InitPins(void)
{
    ...
    // Configure Port E Pins 24-27 to use UART4
    PORT_SetPinMux(PORTC, 12u, kPORT_MuxAlt3); //TX
    PORT_SetPinMux(PORTC, 13u, kPORT_MuxAlt3); //RX
    PORT_SetPinMux(PORTC, 14u, kPORT_MuxAlt3); //CTS_B
    PORT_SetPinMux(PORTC, 15u, kPORT_MuxAlt3); //RTS_B
